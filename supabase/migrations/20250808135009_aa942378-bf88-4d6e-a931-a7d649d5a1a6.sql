-- Re-run without IF NOT EXISTS (not supported here)
...
-- Replace policies
DROP POLICY IF EXISTS "Users can view their own question_appointments" ON public.question_appointments;
CREATE POLICY "Users can view their own question_appointments"
...
DROP POLICY IF EXISTS "Users can insert their own question_appointments" ON public.question_appointments;
CREATE POLICY "Users can insert their own question_appointments"
...
DROP POLICY IF EXISTS "Users can delete their own question_appointments" ON public.question_appointments;
CREATE POLICY "Users can delete their own question_appointments"
...
DROP POLICY IF EXISTS "Users can view their own question_files" ON public.question_files;
CREATE POLICY "Users can view their own question_files"
...
DROP POLICY IF EXISTS "Users can insert their own question_files" ON public.question_files;
CREATE POLICY "Users can insert their own question_files"
...
DROP POLICY IF EXISTS "Users can delete their own question_files" ON public.question_files;
CREATE POLICY "Users can delete their own question_files"
